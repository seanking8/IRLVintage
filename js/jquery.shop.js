(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.paypalBusinessEmail = "seank579@gmail.com"; // Your Business PayPal's account email address
			...
			if( this.$userDetails.length ) {
				if( this.storage.getItem( "shipping-name" ) == null ) {
					...
					var html = "<div class='detail'>";
						html += "<h2 class='title2'>Billing and Shipping</h2>";
						html += "<ul>";
						html += "<li>" + name + "</li>";
						html += "<li>" + email + "</li>";
						html += "<li>" + city + "</li>";
					...
					var html = "<div class='detail'>";
						html += "<h2 class='title2'>Billing</h2>";
						html += "<ul>";
						html += "<li>" + name + "</li>";
						html += "<li>" + email + "</li>";
						html += "<li>" + city + "</li>";
						...
						html += "<h2 class='title2'>Shipping</h2>";
						html += "<ul>";
						html += "<li>" + sName + "</li>";
						html += "<li>" + sEmail + "</li>";
						html += "<li>" + sCity + "</li>";
				...
				if( items.length == 0 ) {
					...
					for( var i = 0; i < items.length; ++i ) {
						...
						var html = "<tr><td class='pname'>" + product + "</td>";
					    	html += "<td class='pdelete'><a href='' data-product='" + product + "'>&times;</a><td class='pprice'>" + price + "</td></td></tr>";
